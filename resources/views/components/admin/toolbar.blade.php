      ...
      <div class="tab-content">
        ...
        <div class="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel">
          ...
          <div class="py-3 text-center border-top">
            <a href="/metronics/pages/profile/activity.html" class="btn btn-color-gray-600 btn-active-color-primary">View All
  ...
  <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
      ...
      <div class="menu-item px-3">
        <div class="menu-content d-flex align-items-center px-3">
          ...
          <div class="d-flex flex-column">
            ...
            <span class="fw-bold text-muted text-hover-primary fs-7 text-capitalize">{{ Auth::user()->role->name }}</span>
          </div>
          <!--end::Username-->
        </div>
      </div>
      ...
      <div class="menu-item px-5">
        <a href="{{ route('profile.home') }}" class="menu-link px-5">My Profile</a>
      </div>
      <!--end::Menu item-->
      <!--begin::Menu item-->
      <div class="menu-item px-5">
